...
class IntegratedWheelchairMapTrackerLive:
    def __init__(self,
        ...
        # ✅ ID별 마커 높이 반영 (원하시면 트랙바로도 뽑아드릴 수 있음)
        ...
        # 해상도/FPS 설정 (장치가 지원 안 하면 무시될 수 있음)
        ...
        # ====== UI (라이브용: Frame 트랙바 제거, Freeze 추가) ======
        ...
        # 첫 프레임으로 초기화 상태 세팅(원하면 HOLD로 고정하고 튜닝 가능)
        self.grab_frames()

    # -------------------------
    # Helpers: live frame grab
    # -------------------------
    ...
    def process_camera_all_markers(self, frame, cam_key, monitor_frame):
        ...
        for i in range(len(ids)):
            ...
            # 모니터 표시 (경고 싫으면 drawFrameAxes 주석)
...
if __name__ == "__main__":
    # rear_cam_index / left_cam_index 는 장치에 따라 바뀔 수 있음 (0/1/2...)
