...
class WheelchairTracker:
    def __init__(self):
        ...
        self.center_offset_cm_by_id = {0: 0.0, 1: 23.0} # 앞은 중앙에, 뒤는 23cm 뒤에
        ...
        # =========================
        # m 단위: near(0~3), mid(3~6), far(6~)
        self.dist_bins_m = [0.0, 3.0, 6.0, 999.0]
        self.dist_blend_m = 0.5  # 경계 부드럽게 보간할 폭
